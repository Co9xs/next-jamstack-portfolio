...
export const TwitterIcon: React.VFC<Props> = (props) => { 
  const { fill, hoverFill, size } = props;
  const sizer = (size) => {
    switch(size) {
      case 'sm':
        return "28px"
  ...
  return (
    <SvgBase hoverFill={hoverFill} fill={fill}>
      <svg version="1.1" width={sizer(size)} height={sizer(size)} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xmlSpace="preserve">
      <g>
...
const SvgBase = styled.div`
  ...
  svg:hover {
    cursor: pointer;
    fill: ${props => props.hoverFill || props.fill};
  }
`